...
export const HOBBY_MAX_LENGTH = 50;
export const HOBBY_MAX_LENGTH_MSSG = MAX_LENGTH_MSSG("Hobby", HOBBY_MAX_LENGTH);

export const HOBBY_MIN_LENGTH = 5;
export const HOBBY_MIN_LENGTH_MSSG = MIN_LENGTH_MSSG("Hobby", HOBBY_MIN_LENGTH);
